=begin
We want to build a single player Tic Tac Tow game where a user can play against the computer

-Decomposing the problem-

Let's write a description of the game:
- Tic Tac Toe is a 2 player game played on a 3x3 board. Each player takes a turn 
  and marks a square on the board. First player to reach 3 squares in a row, including diagonals,
